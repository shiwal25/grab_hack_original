...
if not Google_api:
    sys.stderr.write("ERROR: GOOGLE_API_KEY is missing or invalid. Please check your .env file.\n")
    sys.exit(1)
if not GOOGLE_MAPS_API_KEY:
    sys.stderr.write("ERROR: GOOGLE_MAPS_API_KEY is missing or invalid. Please check your .env file.\n")
    sys.exit(1)
...
async def run_agent():
    ...
    agent = initialize_agent(
        ...
        verbose=False # Crucial for clean JSON output
    )
